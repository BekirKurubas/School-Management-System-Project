function loadStudentsPage() {
    ...
    <div class="header">
        <h3 id="classes-title">Students</h3>
    </div>`

    content += '<div class="card-container mt-4 d-flex justify-content-center">';
            ...
            <div class="Card me-4">
                <div class="card" style="width: 18rem; margin-top: 5px; position: relative;">
                    <div class="card-body">                  
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">${student.className}</h6>
                        <p class="card-text">${student.description}</p>
                        <a href="#" class="card-link">Average Grade: ${student.avarage}</a>                    
                    </div>
                </div>
            </div>
        `;
